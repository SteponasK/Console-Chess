...
public:
	...
	Castling castling{}; //TODO add getCastling function 
	std::vector<boardState> boardStates{}; //TODO add getBoardStates function 
	...
	bool isKingInCheck(const std::array<int, 120>& currentBoard, const int colour); // Overload - specific Board
